...
from my_modules.spectroscopy import spectroscopy
...
def set_settings_tab():
    ...
    __=CreateToolTip(lfwhm, Tooltip_strings.tooltip_fwhm)
    __=CreateToolTip(lsigma, Tooltip_strings.tooltip_sigma)
    __=CreateToolTip(lmstartol,Tooltip_strings.tooltip_tolerance)
    root.mainloop()

def hello(): # just for testing
    print("Hello world")

root=Tk(className=" Easy-Astrometry")
root.geometry("300x200+400+200")
root.iconbitmap('_images/favicon.ico')
menubar=Menu(root)
